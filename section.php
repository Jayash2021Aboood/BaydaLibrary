...
<?php
  if ($_SERVER['REQUEST_METHOD'] === 'GET') 
  {
    ...
    //   جلب بيانات المهندس اعتمادا على المعرف وعرضها في الصفحة
      $result = getAllSectionsWithBookTotals($id);
...
<main class="page">
        ...
        <div class="container-xl px-4">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 mt-4 text-center">
                    ...
                    <p class="mb-0 mt-0 "> Section number : <?php echo $row['number']; ?></p>
                    <p class="mb-0 mt-0 "> Parent ID:<?php echo $row['parent_id']; ?></p>
                    </p>
                </div>
                <!-- <div class="col-md-6 col-sm-12 mt-4 text-center">
    ...
    <div class="container-xl px-4">
        ...
        <div class="row">
            <?php
                $all = getAllBooksByAuthorID($row['id']);
