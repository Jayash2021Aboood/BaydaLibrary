    ...
    if(isset($_POST['deleteLevel']))
    {
      if(isset($_GET['id']))
      {
        ...
        if($delete ==  true)
        {
          ...
          $_SESSION["message"] = "Level Deleted successfuly!";          
          $_SESSION["success"] = "Level Deleted successfuly!";          
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                <!-- Level details card-->
                <div class="card mb-4">
                    <div class="card-header">Level Details <span
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="deleteLevel" class="btn btn-danger" type="submit">Delete</button>
