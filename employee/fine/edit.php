    ...
    if(isset($_POST['updateFine']))
    {
      ...
      if(count($errors) == 0)
      {
        ...
        if($update ==  true)
        {
          ...
          $_SESSION["message"] = "Fine Updated successfuly!";
          $_SESSION["success"] = "Fine Updated successfuly!";
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="updateFine" class="btn btn-success" type="submit">Save</button>
