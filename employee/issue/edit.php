    ...
    if(isset($_POST['updateIssue']))
    {
      ...
      if(count($errors) == 0)
      {
        ...
        if($update ==  true)
        {
          ...
          $_SESSION["message"] = "Issue Updated successfuly!";
          $_SESSION["success"] = "Issue Updated successfuly!";
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="updateIssue" class="btn btn-success" type="submit">Save</button>
