<?php
  ...
  $pageTitle = lang("Edit Department");
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') 
  {
    if(isset($_POST['updateDepartment']))
    {
      ...
      if(count($errors) == 0)
      {
        ...
        $update = updateDepartment( $id,  $college_id,  $name, );
        if($update ==  true)
        {
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select" name="college_id" id="college_id" required>
                                        <option disabled value=""><?php echo lang("Select a College"); ?>:</option>
                                        <?php foreach(getAllColleges() as $College) { ?>
                                        <option <?php if($college_id == $College['id']) echo "selected" ?> value="<?php echo $College['id']; ?>"> <?php echo $College['name']; ?>
                                        </option>
                                        <?php }?>
                                    </select>
                                </div>
                            ...
                            <!-- Submit button-->
                            <button name="updateDepartment" class="btn btn-success" type="submit"><?php echo lang("Save"); ?></button>
