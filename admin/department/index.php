                    ...
                    <tbody>
                        ...
                        <tr>
                                <td> <?php echo($row['id']); ?> </td>
                                  <td> <?php
                                    $College = getCollegeById($row['college_id']) [0];
                                    echo$College['name']; 
                                    ?>
                            </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-0">
                            <label class="mb-1 small text-muted" for="formDepartmentName">Department
                                Name</label>
                            <input class="form-control" id="formDepartmentName" type="text"
                    ...
                    <form>
                        <div class="mb-0">
                            <label class="mb-1 small text-muted" for="formDepartmentName">Department
                                Name</label>
                            <input class="form-control" id="formDepartmentName" type="text"
                                placeholder="Enter Department name..." value="Sales" />
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
