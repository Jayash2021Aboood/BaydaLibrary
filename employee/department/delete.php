    ...
    if(isset($_POST['deleteDepartment']))
    {
      if(isset($_GET['id']))
      {
        ...
        if($delete ==  true)
        {
          ...
          $_SESSION["success"] = "Department Deleted successfuly!";          
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    <div class="card-header">Department Details <span
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="college_id" name="college_id" type="text" placeholder="College"
                            ...
                            <!-- Submit button-->
                            <button name="deleteDepartment" class="btn btn-danger" type="submit">Delete</button>
