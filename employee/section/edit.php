    ...
    if(isset($_POST['updateSection']))
    {
      ...
      if(count($errors) == 0)
      {
        ...
        if($update ==  true)
        {
          ...
          $_SESSION["message"] = "Section Updated successfuly!";
          $_SESSION["success"] = "Section Updated successfuly!";
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="updateSection" class="btn btn-success" type="submit">Save</button>
