...
<main>
                        ...
                        <!-- <tr> 
                                            ...
                                            <td>
                                                <button class="btn btn-datatable btn-icon btn-transparent-dark me-2"
                                                    ...
                                                    data-bs-target="#editCollegeModal"><i
    ...
    <div class="modal fade" id="createCollegeModal" tabindex="-1" role="dialog" aria-labelledby="createCollegeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createCollegeModalLabel">Create New College</h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="mb-0">
                            <label class="mb-1 small text-muted" for="formCollegeName">College
                                Name</label>
                            <input class="form-control" id="formCollegeName" type="text"
                    ...
                    <form>
                        <div class="mb-0">
                            <label class="mb-1 small text-muted" for="formCollegeName">College
                                Name</label>
                            <input class="form-control" id="formCollegeName" type="text"
                                placeholder="Enter College name..." value="Sales" />
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
