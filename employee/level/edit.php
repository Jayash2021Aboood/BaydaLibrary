  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') 
  {
    if(isset($_POST['updateLevel']))
    {
      ...
      if(count($errors) == 0)
      {
        ...
        $update = updateLevel( $id,  $name, );
        if($update ==  true)
        {
  
          $_SESSION["message"] = lang("Level Updated successfuly!");
          $_SESSION["success"] = lang("Level Updated successfuly!");
                ...
                <div class="row align-items-center justify-content-between pt-3">
                    <div class="col-auto mb-3">
                        <h1 class="page-header-title">
                            ...
                            <?php echo lang("Edit Level"); ?>
                        </h1>
                    </div>
                    <div class="col-12 col-xl-auto mb-3">
                        <a class="btn btn-sm btn-light text-primary" href="index.php">
                            <i class="me-1" data-feather="arrow-left"></i>
                            <?php echo lang("Back to Levels List"); ?>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                <!-- Level details card-->
                <div class="card mb-4">
                    <div class="card-header"><?php echo lang("Level Details"); ?></div>
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="updateLevel" class="btn btn-success" type="submit"><?php echo lang("Save"); ?></button>
