    ...
    if(isset($_POST['deleteSection']))
    {
      if(isset($_GET['id']))
      {
        ...
        if($delete ==  true)
        {
          ...
          $_SESSION["message"] = "Section Deleted successfuly!";          
          $_SESSION["success"] = "Section Deleted successfuly!";          
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    <div class="card-header">Section Details <span
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="parent_id" name="parent_id" type="text" placeholder="Parent"
                            ...
                            <!-- Submit button-->
                            <button name="deleteSection" class="btn btn-danger" type="submit">Delete</button>
