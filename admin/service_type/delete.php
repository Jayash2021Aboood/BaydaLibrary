...
<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') 
  {
    if(isset($_POST['deleteServiceType']))
    {
      ...
      {
        $id = $_POST['id'];
        $delete = deleteServiceType($id);
        if($delete ==  true)
        {
  
          $_SESSION["message"] = "ServiceType Deleted successfuly!";          
          $_SESSION["success"] = "ServiceType Deleted successfuly!";          
          header('Location:'. $PATH_ADMIN_SERVICE_TYPE .'index.php');
          exit();
        }
        else
        {
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    <div class="card-header">ServiceType Details <span
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="deleteServiceType" class="btn btn-danger" type="submit">Delete</button>
