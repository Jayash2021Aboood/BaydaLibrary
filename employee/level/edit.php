    ...
    if(isset($_POST['updateLevel']))
    {
      ...
      if(count($errors) == 0)
      {
        ...
        if($update ==  true)
        {
          ...
          $_SESSION["message"] = "Level Updated successfuly!";
          $_SESSION["success"] = "Level Updated successfuly!";
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="updateLevel" class="btn btn-success" type="submit">Save</button>
